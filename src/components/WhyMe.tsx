    ...
    >
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {strengths.map((s, i) => (
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center mb-4 shadow-md"><Icon name={s.icon} size={20} className="text-white" /></div>
      ...
      <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm mb-8">
        <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
          <span className="w-10 h-10 rounded-xl bg-blue-600 inline-flex items-center justify-center flex-shrink-0"><Icon name={"flask"} size={18} className="text-white" /></span> Testing & Acceptance Approach
        </h3>
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-8">
        <h3 className="text-xl font-bold text-green-900 mb-4 flex items-center gap-2">
          <span className="w-10 h-10 rounded-xl bg-blue-600 inline-flex items-center justify-center flex-shrink-0"><Icon name={"shield"} size={18} className="text-white" /></span> Post-Launch Support & Maintenance
        </h3>
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-green-700">
              <li>• $500–$700/month</li>
              <li>• 13–17 hrs/month @ $40/hr</li>
              <li>• + availability/priority premium</li>
